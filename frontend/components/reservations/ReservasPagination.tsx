import { paginaBtnStyle } from "../../src/styles/reservaStyles";

type ReservasPaginationProps = {
  pagina: number;
  totalPaginas: number;
  inicio: number;
  totalItens: number;
...
export default function ReservasPagination({
  pagina,
  totalPaginas,
  inicio,
  totalItens,
  ...
  return (
    ...
    >
      <span style={{ fontSize: "13px", color: "#6b7280" }}>
        ...
        {totalItens} reserva{totalItens !== 1 ? "s" : ""}
      </span>
